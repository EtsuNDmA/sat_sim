...
MODEL                  = ACStesbed
MODULES                = ACStesbed_data.c is_little_endian_rt.c rtGetInf.c rtGetNaN.c rt_logging.c rt_nonfinite.c svd_d_rt.c svd_helper_rt.c 
MAKEFILE               = ACStesbed.mk
...
MODELLIB                  = ACStesbedlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = ACStesbed_ref.rsp
MODELREF_INC_PATH         = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\slprj\raccel\ACStesbed
...
{$(MATLAB_ROOT)\toolbox\dsp\extern\src\dspsvd}.c.obj :
	$(CC) $(CFLAGS) $<

{$(MATLAB_ROOT)\toolbox\dsp\extern\src\dspendian}.c.obj :
	$(CC) $(CFLAGS) $<
...
{$(MATLAB_ROOT)\toolbox\dsp\extern\src\dspsvd}.cpp.obj :
	$(CC) $(CPPFLAGS) $<

{$(MATLAB_ROOT)\toolbox\dsp\extern\src\dspendian}.cpp.obj :
	$(CC) $(CPPFLAGS) $<
